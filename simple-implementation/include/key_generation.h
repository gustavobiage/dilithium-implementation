...
struct secret_key {
	...
	struct secret_key<K, L, N, Q> & operator=(const struct secret_key<K, L, N, Q> &);
};
...
struct public_key {
	...
	struct public_key<K, L, N, Q> & operator=(const struct public_key<K, L, N, Q> &);
};
...
struct key_pair {
	...
	struct key_pair<K, L, N, Q> & operator=(const struct key_pair<K, L, N, Q> &);
};
