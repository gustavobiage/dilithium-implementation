...
//                 b[j] = multiply_montgomery<Q>(_2, b[j], Q);
//                 b[j + degree] = subtract(t, b[j+degree], Q);
//                 b[j + degree] = multiply_montgomery<Q>(zeta, b[j + degree], Q);
//                 b[j + degree] = multiply_montgomery<Q>(_2, b[j + degree], Q);
//             }
//         }
//         n_polynomials /= 2;
//     }
//     for (int i = 0; i < N; i++) {
//         b[i] = inverse_montgomery_reduction<Q>(b[i]);
//         b[i] = (b[i] + Q) % Q;  
//     }
//     return b;
// }
